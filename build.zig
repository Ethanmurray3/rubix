...
pub fn build(b: *std.Build) void {
    ...
    addRunTest(test_step, addTestFile(b, mod, target, optimize, "test/cfop_recognition_test.zig"), b);
    ...
    addRunTest(test_step, addTestFile(b, mod, target, optimize, "test/progress_test.zig"), b);

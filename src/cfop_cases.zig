...
const pll_ua_setup = [_]Move{ .R2, .U, .R, .U, .R, .U, .RPrime, .UPrime, .RPrime, .UPrime, .RPrime };
const pll_ua_solution = [_]Move{ .R, .U, .R, .U, .R, .UPrime, .RPrime, .UPrime, .RPrime, .UPrime, .R2 };

const pll_ub_setup = [_]Move{ .R, .UPrime, .R, .U, .R, .U, .RPrime, .UPrime, .RPrime, .UPrime, .R2 };
const pll_ub_solution = [_]Move{ .R2, .U, .R, .U, .R, .UPrime, .RPrime, .UPrime, .RPrime, .U, .RPrime };
